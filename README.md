...
| Name         | Size | Current PCB | Notes                     |
|--------------|------|-------------|---------------------------|
| [Clock Divider 1](https://github.com/thismatters/EurorackClockDiv/) | 1U 11hp | ~[V0]()~ | Manu |
| [Clock Divider 2](https://github.com/thismatters/EurorackClockDivTwo/) | 1U 10hp  | ~[V0]()~ | Manu |
